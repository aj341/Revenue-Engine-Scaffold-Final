...
const NAV_ITEMS = [
  ...
  { label: "Analyses", href: "/analyses", icon: Search, soon: true },
  { label: "Issue Clusters", href: "/issues", icon: Layers, soon: true },
  { label: "Insight Library", href: "/insights", icon: Lightbulb, soon: true },
  { label: "Message Generator", href: "/messages", icon: MessageSquare, soon: true },
  { label: "Sequences", href: "/sequences", icon: GitBranch, soon: true },
  { label: "Execution Queue", href: "/queue", icon: ListChecks, soon: true },
